...
{{-- page title --}}
@section('page_title', 'New Arm')
@section('content')

<div class="container-fluid py-2">
    <div class="mb-4">
        <h2 class="fs-4 fw-bold text-dark mb-1">{{ "Create New Arm" }}</h2>
    ...
    <div class="card border border-light shadow-sm rounded-4 overflow-hidden">
        ...
        <form action="{{ route('admin.arms.store') }}" method="POST">
            @csrf
            <div class="card-body p-3 p-md-4">
                <div class="mb-3">
                    <label for="name" class="form-label">Arm Name</label>
               ...
               {{--<div class="mb-3">
                ...
                <div class="d-grid d-md-block mt-3">
                    <button type="submit" class="btn btn-primary">Create Arm</button>
                </div>
            </div>
        </form>
    </div>
