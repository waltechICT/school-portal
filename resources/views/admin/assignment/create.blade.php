...
@section('page_title', 'Add New Assignment')
...
<div class="container-fluid py-3 py-md-4">
    <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fs-4 fs-md-3 fw-bold text-dark mb-1">Add New Assignment</h2>
            <p class="text-muted small mb-0">Fill out the form below to create a new assignment for your students.</p>
        </div>
                    ...
                    <div class="card-body pt-0">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="note" id="note" class="form-control bg-light border-0 rounded-3 summernote" rows="6">{{ old('note') }}</textarea>
                            </div>

                            <div class="col-12 col-sm-6">
                                <label for="submittion_date" class="form-label fw-medium">Submission date <span class="text-danger">*</span></label>
                                <input type="datetime-local" name="submittion_date" id="submittion_date" class="form-control bg-light border-0 py-2 px-3 rounded-3" value="{{ old('submittion_date') }}" max="9999-12-31T23:59" required>
                            </div>
                        </div>
                    </div>
                </div>
