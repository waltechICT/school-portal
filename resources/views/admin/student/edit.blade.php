...
<div class="container-fluid py-3 py-md-4">
    <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fs-4 fs-md-3 fw-bold text-dark mb-1">Edit Student Details</h2>
            <p class="text-muted small mb-0">Update information for {{ $student->surname }} {{ $student->other_names }}.</p>
        </div>
                    ...
                    <div class="card-body pt-0">
                        <div class="row g-3">
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" name="student_id" id="student_id" class="form-control bg-light border-0 py-2 px-3 rounded-3 @error('student_id') is-invalid @enderror" value="{{ old('student_id', $student->student_id) }}" required>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" name="admission_no" id="admission_no" class="form-control bg-light border-0 py-2 px-3 rounded-3 @error('admission_no') is-invalid @enderror" value="{{ old('admission_no', $student->admission_no) }}" required>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" name="surname" id="surname" class="form-control bg-light border-0 py-2 px-3 rounded-3 @error('surname') is-invalid @enderror" value="{{ old('surname', $student->surname) }}" required>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" name="other_names" id="other_names" class="form-control bg-light border-0 py-2 px-3 rounded-3 @error('other_names') is-invalid @enderror" value="{{ old('other_names', $student->other_names) }}" required>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <select name="is_enabled" id="is_enabled" class="form-select bg-light border-0 py-2 px-3 rounded-3 @error('is_enabled') is-invalid @enderror" required>
                                    ...
                                    <option value="0" {{ old('is_enabled', $student->is_enabled) == 0 ? 'selected' : '' }}>Disabled</option>
                                </select>
                            ...
                            <div class="col-12 col-sm-8">
                                ...
                                <input type="date" name="date_of_birth" id="date_of_birth" class="form-control bg-light border-0 py-2 px-3 rounded-3 @error('date_of_birth') is-invalid @enderror" value="{{ old('date_of_birth', $student->date_of_birth) }}" required>
                    ...
                    <div class="card-body pt-0">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" name="guardian_name" id="guardian_name" class="form-control bg-light border-0 py-2 px-3 rounded-3 @error('guardian_name') is-invalid @enderror" value="{{ old('guardian_name', $student->guardian_name) }}" required>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" name="guardian_phone" id="guardian_phone" class="form-control bg-light border-0 py-2 px-3 rounded-3 @error('guardian_phone') is-invalid @enderror" value="{{ old('guardian_phone', $student->guardian_phone) }}" required>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" name="guardian_occupation" id="guardian_occupation" class="form-control bg-light border-0 py-2 px-3 rounded-3 @error('guardian_occupation') is-invalid @enderror" value="{{ old('guardian_occupation', $student->guardian_occupation) }}" required>
            ...
            <div class="col-12 col-lg-4 order-1 order-lg-2">
                    ...
                    <div class="card-body text-center pb-4">
                        <div class="mb-3 d-flex justify-content-center">
                            <div class="rounded-circle bg-light d-flex align-items-center justify-content-center shadow-sm border" style="width: 120px; height: 120px; overflow: hidden;" id="passportPreview">
                                <img src="{{ asset($student->student_passport) }}" style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
                        </div>
                        <div class="px-2 px-md-3">
                            <p class="text-muted small mb-3">Upload a new photo to change (JPEG/PNG format)</p>
                            <input type="file" name="student_passport" id="student_passport" class="form-control form-control-sm border-0 bg-light rounded-3 @error('student_passport') is-invalid @enderror" onchange="previewImage(event)">
                ...
                <div class="card border-0 bg-primary text-white shadow-sm rounded-4 overflow-hidden">
                    <div class="card-body p-4">
                        ...
                        <p class="small opacity-75 mb-4">Update the student record with the new information provided above.</p>
